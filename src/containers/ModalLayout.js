                    ...
                    {
                        {
                            ...
                            [MODAL_BODY_TYPES.TOP_CATEGORY_ADD_NEW]: <TopCategoryModalBody size={size} closeModal={close} extraObject={extraObject} />,
                            [MODAL_BODY_TYPES.TOP_PRODUCT_ADD_NEW]: <TopProductModalBody size={size} closeModal={close} extraObject={extraObject} />,
